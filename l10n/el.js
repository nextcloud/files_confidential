OC.L10N.register(
    ...
    "Metadata value" : "Τιμή μεταδεδομένων",
    "Add" : "Προσθήκη",
    "… or if document contains" : "… ή εάν το έγγραφο περιέχει",
    "Enter Regular Expression" : "Εισαγάγετε την κανονική έκφραση",
    "Search expressions within documents" : "Εκφράσεις αναζήτησης εντός εγγράφων",
    "Remove search expression" : "Κατάργηση έκφρασης αναζήτησης",
    "Regular search expression" : "Κανονική έκφραση αναζήτησης",
    "Remove regular expression" : "Κατάργηση κανονικής έκφρασης",
    "Search keywords within documents" : "Λέξεις-κλειδιά αναζήτησης εντός εγγράφων",
    "Search keyword" : "Λέξη-κλειδί αναζήτησης",
    "Remove search keyword" : "Κατάργηση λέξης-κλειδιού αναζήτησης",
    "Can not add new label, until all labels have a tag assigned." : "Δεν μπορεί να προστεθεί νέα ετικέτα, έως ότου όλες οι ετικέτες έχουν αντιστοιχηθεί σε ετικέτα.",
    "Failed to save settings" : "Αποτυχία αποθήκευσης ρυθμίσεων",
    "Policy uploaded successfully" : "Η πολιτική μεταφορτώθηκε με επιτυχία",
    "Business Authorization Framework" : "Πλαίσιο Επιχειρηματικής Εξουσιοδότησης",
    "Upload your TSCP/BAILS policy classification labels (XML format)" : "Μεταφορτώστε τις ετικέτες ταξινόμησης πολιτικής TSCP/BAILS (μορφή XML)",
