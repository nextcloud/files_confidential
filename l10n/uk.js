OC.L10N.register(
    ...
    "Metadata value" : "Значення метаданих",
    "Add" : "Додати",
    "… or if document contains" : "... або документ містить",
    "Enter Regular Expression" : "Зазначте регулярний вираз",
    "Search expressions within documents" : "Шукати вираз в тексті документу",
    "Remove search expression" : "Вилучити пошукову фразу",
    "Regular search expression" : "Пошуковий регулярний вираз",
    "Remove regular expression" : "Вилучити регулярний вираз",
    "Search keywords within documents" : "Шукати ключові слова всередині документу",
    "Search keyword" : "Шукати ключові слова",
    "Remove search keyword" : "Вилучити пошук ключових слів",
    "Can not add new label, until all labels have a tag assigned." : "Не вдалося додати новий ярлик, оскільки не всім ярликам було призначено мітки.",
    "Failed to save settings" : "Неможливо зберегти налаштування",
    "Policy uploaded successfully" : "Політику успішно завантажено",
    "Business Authorization Framework" : "Конструктор з визначення класифікації ресурсів",
    "Upload your TSCP/BAILS policy classification labels (XML format)" : "Завантажити власні ярлики класифікації політики TSCP/BAILS у форматі XML",
