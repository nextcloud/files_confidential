OC.L10N.register(
    ...
    "Metadata value" : "Значение метаданных",
    "Add" : "Добавить",
    "… or if document contains" : "… или если документ содержит",
    "Enter Regular Expression" : "Введите регулярное выражение",
    "Search expressions within documents" : "Поиск выражений в документах",
    "Remove search expression" : "Удалить выражение поиска",
    "Regular search expression" : "Регулярное выражение поиска",
    "Remove regular expression" : "Удалить регулярное выражение",
