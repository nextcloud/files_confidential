OC.L10N.register(
    ...
    "Define classification rules that apply tags to different documents. Based on these tags you can define rules in Nextcloud Flow." : "قُم بتعريف قواعد التصنيف التي تتيح توسيم المستندات المختلفة. بناءً على هذه الوسوم يمكنك تعريف قواعد للانسياب الإجرائي في نكست كلاود.",
