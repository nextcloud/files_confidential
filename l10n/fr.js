OC.L10N.register(
    "files_confidential",
    {
    "Unsupported file type for import. An XML file is expected." : "Ce type de fichier n'est pas pris en charge pour l'importation. Un fichier XML est préférable.",
    ...
    "Add" : "Ajouter",
    "… or if document contains" : "… ou si document contient ",
    ...
    "Regular search expression" : "Recherche d'expression régulière",
    ...
    "Can not add new label, until all labels have a tag assigned." : "Impossible d'ajouter un nouveau label tant qu'un tag n'a pas été attribuée à toutes les labels.",
