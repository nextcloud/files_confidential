OC.L10N.register(
    ...
    "Select or create tag" : "Sélectionner ou créer une étiquette",
    ...
    "Metadata value" : "Valeur de métadonnée",
    "Add" : "Ajouter",
    "… or if document contains" : "… ou si le document contient ",
    "Enter Regular Expression" : "Saisir une expression régulière",
    "Search expressions within documents" : "Rechercher des expressions dans les documents",
    "Remove search expression" : "Supprimer l'expression de recherche",
    "Regular search expression" : "Expression de recherche régulière",
    "Remove regular expression" : "Supprimer l'expression régulière",
    "Search keywords within documents" : "Rechercher des mots-clés dans les documents",
    "Search keyword" : "Rechercher un mot-clé",
    "Remove search keyword" : "Supprimer le mot-clé de la recherche",
    "Can not add new label, until all labels have a tag assigned." : "Impossible d'ajouter un nouveau libellé tant que tous les libellé n'ont pas reçu une étiquette.",
    "Failed to save settings" : "Impossible d'enregistrer les paramètres",
    "Policy uploaded successfully" : "Politique chargée avec succès",
    "Tag \"{tag}\" created successfully" : "L'étiquette « {tag} » a été créée avec succès",
    "Failed to create tag \"{tag}\"" : "Échec de la création de l'étiquette « {tag} »",
    "Business Authorization Framework" : "Business Authorization Framework",
    "Upload your TSCP/BAILS policy classification labels (XML format)" : "Téléversez vos libellés de classification de politique TSCP/BAILS (format XML)",
