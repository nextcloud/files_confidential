OC.L10N.register(
    ...
    "Metadata value" : "Vrijednost metapodataka",
    "Add" : "Dodaj",
    "… or if document contains" : "… ili ako dokument sadrži",
    "Enter Regular Expression" : "Unesite regularni izraz",
    "Search expressions within documents" : "Pretraživanje izraza unutar dokumenata",
    "Remove search expression" : "Ukloni izraz za pretraživanje",
    "Regular search expression" : "Regularni izraz za pretraživanje",
    "Remove regular expression" : "Ukloni regularni izraz",
    "Search keywords within documents" : "Pretraživanje ključnih riječi unutar dokumenata",
    "Search keyword" : "Traži ključnu riječ",
    "Remove search keyword" : "Ukloni ključnu riječ za pretraživanje",
    "Can not add new label, until all labels have a tag assigned." : "Nije moguće dodati novu oznaku dok svim oznakama nije dodijeljena oznaka.",
    "Failed to save settings" : "Spremanje postavki nije uspjelo",
    "Policy uploaded successfully" : "Pravila su uspješno prensena",
    "Business Authorization Framework" : "Okvir poslovne autorizacije",
    "Upload your TSCP/BAILS policy classification labels (XML format)" : "Prenesite svoje TSCP/BAILS oznake klasifikacije pravila (XML format)",
    "Upload policy" : "Prenesi pravila",
